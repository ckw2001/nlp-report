...
print(f'KNN & BERT & CL Validation F1 Score with Lambda(0.5): {val_f1}')
print(f'KNN & BERT & CL Validation Accuracy with Lambda(0.5): {val_acc}')
f_1.write(f'KNN & BERT & CL Validation F1 Score with Lambda(0.5): {val_f1}' + '\n')
f_1.write(f'KNN & BERT & CL Validation Accuracy with Lambda(0.5): {val_acc}' + '\n')

val_f1, val_acc = final_eval_model(model, val_data_loader, device, 1,5)
print(f'KNN & BERT & CL Validation F1 Score with Lambda(1): {val_f1}')
print(f'KNN & BERT & CL Validation Accuracy with Lambda(1): {val_acc}')
f_1.write(f'KNN & BERT & CL Validation F1 Score with Lambda(1): {val_f1}' + '\n')
f_1.write(f'KNN & BERT & CL Validation Accuracy with Lambda(1): {val_acc}' + '\n')
